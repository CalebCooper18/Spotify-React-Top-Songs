...
export default function Select({defaultValue, values, changeURL}) {
  ...
  return (
    <select value={defaultValue} className='w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500' onChange={handleChange}>
